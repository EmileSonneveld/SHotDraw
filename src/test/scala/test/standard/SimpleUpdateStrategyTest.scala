...
import org.shotdraw.standard.SimpleUpdateStrategy
 ...
 * @see org.shotdraw.standard.SimpleUpdateStrategy
 */
class SimpleUpdateStrategyTest(name: String) extends TestCase(name) {

  /**
   * Factory method for instances of the class to be tested.
   */
  def createInstance: SimpleUpdateStrategy = {
